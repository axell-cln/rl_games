...
class BasicPpoPlayerContinuous(BasicBasePlayer):
    def __init__(self, params, observation_space, action_space, clip_actions=True, deterministic=False, device="cuda"):
        BasicBasePlayer.__init__(self, params, observation_space, action_space, clip_actions, deterministic, device)
